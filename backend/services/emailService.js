    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; background:#f4f5f7; padding:24px;">
      <div style="max-width:620px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.06);">
        ...
        <div style="padding:28px 32px;">
          ...
          <p style="font-size:14px;color:#6b7280;margin:0 0 20px;line-height:1.5;">${introText}</p>
          ...
          <div style="display:flex;gap:16px;align-items:center;background:#ffffff;border:1px solid #eef0f3;border-radius:12px;padding:16px;margin-bottom:20px;">
            ${imageBlock}
            <div style="flex:1;">
              <p style="margin:0 0 6px;font-size:16px;font-weight:700;color:#111827;">${escapeHtml(p.name)}</p>
      ...
      <div style="max-width:620px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.06);">
        ...
        <div style="padding:28px 32px;">
          ...
          <div style="background:#ffffff;border:1px solid #eef0f3;border-radius:12px;padding:16px;margin-bottom:20px;">
            <p style="margin:0 0 6px;font-size:15px;font-weight:700;color:#111827;">Product: ${escapeHtml(p.name)}</p>
...
module.exports = { sendOrderConfirmationEmail, buildOrderEmailHtml, sendCustomerOrderEmail, buildCustomerOrderEmailHtml, sendOrderStatusUpdateEmails, sendCustomizationEmail, buildCustomizationEmailHtml, sendCustomizationCustomerEmail, buildCustomizationCustomerEmailHtml };
